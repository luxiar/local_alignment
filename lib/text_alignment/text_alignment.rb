#!/usr/bin/env ruby
require 'diff-lcs'
require './lib/text_alignment/lcs_min.rb'
require './lib/text_alignment/find_divisions.rb'
require './lib/text_alignment/lcs_comparison.rb'
require './lib/text_alignment/lcs_alignment.rb'
require './lib/text_alignment/glcs_alignment.rb'
require './lib/text_alignment/mapping.rb'
...
if __FILE__ == $0
  require 'json'
  require './lib/text_alignment/lcs_cdiff.rb'
